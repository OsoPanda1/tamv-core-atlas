...
export const CANON_ENTITIES: CanonEntity[] = [
  ...
  },
  {
    ...
    dependencies: [
      "TAMV.COG.AI.ISABELLA.V1",
      "TAMV.ECO.LEDGER.BOOKPI.V1",
      "TAMV.DEF.GUARD.ANUBIS.V1",
    ],
...
export const INGESTION_SOURCES: IngestionSource[] = [
  {
    id: "ing-001",
    url: "github://OsoPanda1/isabella-core",
    kind: "github",
    federation: "cognition",
    status: "ingested",
    files: 142,
    ...
    lastRun: "T-00:04:21",
    traceId: "repo.ingestion-7m2x4a",
  },
  {
    id: "ing-002",
    url: "github://OsoPanda1/eoct-runtime",
    kind: "github",
    federation: "governance",
    status: "ingested",
    files: 88,
    ...
    lastRun: "T-00:09:48",
    traceId: "repo.ingestion-7m1p9b",
  },
  {
    id: "ing-003",
    url: "github://OsoPanda1/bookpi-ledger",
    kind: "github",
    federation: "economy",
    status: "ingested",
    files: 64,
    entitiesExtracted: 9,
    lastRun: "T-00:12:02",
    traceId: "repo.ingestion-7m0kq2",
  },
  {
    id: "ing-004",
    url: "github://OsoPanda1/rdm-node-zero",
    kind: "github",
    federation: "infra",
    status: "running",
    files: 211,
    ...
    lastRun: "T-00:00:14",
    traceId: "repo.ingestion-7m3z8f",
  },
  {
    id: "ing-005",
    url: "zenodo://10.5281/zenodo.19436662",
    kind: "zenodo",
    federation: "science",
    status: "ingested",
    files: 6,
    entitiesExtracted: 6,
    lastRun: "T-00:22:55",
    traceId: "doc.ingestion-7m2a1c",
  },
  {
    id: "ing-006",
    url: "manifest://heptafed.yaml",
    kind: "manifest",
    federation: "governance",
    status: "queued",
    files: 1,
    entitiesExtracted: 0,
    lastRun: "—",
    traceId: "manifest-7m4r2d",
  },
  {
    id: "ing-007",
    url: "webhook://github/push#main",
    kind: "webhook",
    federation: "infra",
    status: "ingested",
    files: 3,
  ...
  {
    id: "ing-008",
    url: "github://OsoPanda1/anubis-sentinel",
    kind: "github",
    federation: "defense",
    status: "failed",
    files: 0,
...
export const BOOKPI_EVENTS: BookPiEvent[] = [
  {
    ...
    ts: "T-00:00:08",
    eventType: "INGESTION",
    entityId: "TAMV.INF.NODE.RDM.V1",
    hash: "61aa37e0fbc9",
    source: "github://OsoPanda1/rdm-node-zero/README.md",
    traceId: "repo.ingestion-7m3z8f",
  },
  {
    id: "bp-1800",
    ts: "T-00:00:21",
    eventType: "CANONIZATION",
    entityId: "TAMV.INF.NODE.RDM.V1",
    hash: "61aa37e0fbc9",
    source: "canon-registry",
    traceId: "repo.ingestion-7m3z8f",
  },
  {
    id: "bp-1799",
  ...
  },
  {
    ...
    ts: "T-00:01:11",
    eventType: "INGESTION",
    entityId: "TAMV.COG.AI.ISABELLA.V1",
    hash: "9a4f6c1e8b22",
    source: "github://OsoPanda1/isabella-core/package.json",
    traceId: "repo.ingestion-7m2x4a",
  },
  {
    id: "bp-1797",
    ...
    traceId: "assembly-7m4y1z",
  },
  {
    id: "bp-1796",
    ts: "T-00:02:32",
    eventType: "CONFLICT",
    entityId: "TAMV.COG.DOC.KORIMA.V1",
    hash: "f0e2d8b4a019",
    source: "korima-validator",
    traceId: "validation-7m1k02",
  },
  {
    id: "bp-1795",
    ts: "T-00:03:04",
    ...
    entityId: "TAMV.COG.DOC.KORIMA.V1",
    hash: "f0e2d8b4a019",
    source: "isabella-analyst",
    traceId: "merge-7m1k15",
  },
  {
    id: "bp-1794",
    ts: "T-00:03:55",
    eventType: "CANONIZATION",
    entityId: "TAMV.GOV.PROTO.EOCT.V1",
    hash: "c1b87a3041ff",
    source: "canon-registry",
    traceId: "repo.ingestion-7m1p9b",
  },
  {
    ...
    ts: "T-00:04:40",
    eventType: "PROJECTION",
    entityId: "TAMV.DEF.GUARD.HORUS.V1",
    hash: "8b7c5d12af30",
    source: "neo4j://tamv-graph",
    traceId: "repo.ingestion-7m0v8c",
  },
  {
    id: "bp-1792",
    ts: "T-00:05:18",
    eventType: "INGESTION",
    entityId: "TAMV.ECO.LEDGER.BOOKPI.V1",
    hash: "7d29ac51e604",
    source: "github://OsoPanda1/bookpi-ledger/README.md",
    traceId: "repo.ingestion-7m0kq2",
  },
  {
    id: "bp-1791",
    ts: "T-00:06:02",
    eventType: "ASSEMBLY",
    entityId: "TAMV.COG.MOD.MDX5.V1",
    hash: "9912ab23cd14",
    source: "self-assembly",
    traceId: "assembly-7m3x09",
  },
  {
    id: "bp-1790",
    ts: "T-00:07:21",
