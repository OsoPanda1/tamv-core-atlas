  ...
  head: () => ({
    meta: [
      { title: "Event Stream · TAMV Mission Control" },
      {
        name: "description",
        content:
          "Live observability feed: sentinel alerts, node health, constitutional violations, runtime execution.",
      },
      { property: "og:title", content: "Event Stream · TAMV" },
      {
        property: "og:description",
        content: "Mission-control observability across the seven federations.",
      },
    ],
  }),
              ...
              {EVENTS.map((e) => (
                <li key={e.id} className="px-5 py-3.5 hover:bg-secondary/40 transition-colors">
                  <div className="flex items-center gap-4">
                    <span className="mono text-[10px] uppercase tracking-wider text-muted-foreground tabular w-20">
                      {e.ts}
                    </span>
                    <span
                      className={cn("mono text-[10px] uppercase tracking-wider w-20", {
                    ...
                    <span className="mono text-[10px] uppercase tracking-wider text-muted-foreground w-28">
                      {e.source}
                    </span>
